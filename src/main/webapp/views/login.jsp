...
<%-- 
    login.jsp - Formulaire de connexion (page standalone, sans sidebar)
    ====================================================================
    Placée dans views/ (HORS WEB-INF) pour être accessible via :
        return "views/login.jsp";   // String return → FrontServlet dispatche "views/..."
    
    Variables utilisées :
    - ${erreur} : message d'erreur (request attribute, optionnel)
--%>
<!DOCTYPE html>
<html>
<head>
    ...
    <style>
        ...
        .login-header h1 { color: #667eea; margin: 0 0 10px 0; font-size: 2em; }
        .login-header p { color: #666; margin: 0; }
        .error-message {
            background: #fee; color: #c33; padding: 10px;
            border-radius: 5px; margin-bottom: 20px; border-left: 4px solid #c33;
        }
