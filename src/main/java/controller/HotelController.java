 ...
 * CRUD Hôtels
 * ==============
 * Même pattern que ReservationController :
 * ModelAndView("/views/...") + pageTitle + données métier
 */
@Controller
public class HotelController {
    ...
    public ModelAndView listerHotels() {
        ModelAndView mav = new ModelAndView("/views/hotel/liste-hotels.jsp");
    ...
    public ModelAndView afficherFormulaireHotel() {
        ModelAndView mav = new ModelAndView("/views/hotel/formulaire-hotel.jsp");
    ...
    public ModelAndView voirHotel(@RequestParam("id") int id) {
        ...
        ModelAndView mav = new ModelAndView("/views/hotel/details-hotel.jsp");
    ...
    public ModelAndView editerHotel(@RequestParam("id") int id) {
        Hotel hotel = hotelService.getHotelById(id);
        ModelAndView mav = new ModelAndView("/views/hotel/edition-hotel.jsp");
    ...
    public ModelAndView traiterFormulaireHotel(
        ...
        if (success) {
            ModelAndView mav = new ModelAndView("/views/hotel/confirmation-hotel.jsp");
