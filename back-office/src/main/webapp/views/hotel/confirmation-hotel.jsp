...
<div class="container">
    <div class="confirmation-message text-center">
        ...
        <div class="actions mt-4">
            <a href="${pageContext.request.contextPath}/hotels/create" class="btn btn-primary mr-2">
                <i class="fas fa-plus"></i> Ajouter un autre hôtel
            </a>
            <a href="${pageContext.request.contextPath}/hotels/list" class="btn btn-secondary">
                <i class="fas fa-list"></i> Voir la liste des hôtels
            </a>
        </div>
    </div>
</div>
